...
int main(int argc, char** argv){
    ...
    cout<<"Generating DPF keys for DPF table..."<<endl;    
    ...
    copy_keys_to_server(cl->dpf_table_oracle->key[ctr], svk1, svk2);
    ...
    INIT_TIMER;
    START_TIMER;
    sv1->dpf_table_oracle->eval_dpf_table(res1, gout_bitsize, true, group_mod, 0);
    sv2->dpf_table_oracle->eval_dpf_table(res2, gout_bitsize, true, group_mod, 0);
    ...
    assert(check_dpf_table_correctness(query_x, u_table, res1, res2, size, depth, true, group_mod, alpha) == true && "DPF table is incorrect!");
